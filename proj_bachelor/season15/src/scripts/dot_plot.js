...
.enter()
.append('svg:image')
    .attr("xlink:href", "./imgs/rose-02.svg")
    .attr("width", 30)
    .attr("height", 30)
    .attr("x", 0)
...
d3.select('#two2').on('stepin', () => {
  ...
  svg.selectAll('.label-season').style('visibility', 'visible')
