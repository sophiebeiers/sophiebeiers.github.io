...
svg.append("g")
  ...
  .call(d3.axisTop(xScale).ticks(8).tickFormat(function(d,i){return weeks[i]}))
  .selectAll("text")
      ...
      .attr("stroke", "pink")
        ...
        .attr("d", function(d){
          return d3.line()
            ...
            .y(function(d) { return yScale(+d.place) * 1.9; })
            (d.values)
        })
...
// circles
  svg.selectAll(".men")
      ...
      .attr("cy", function(d){return yScale(d.place) * 1.9})
